...
export const SilkBackground = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Note: running this on the CPU pixel-by-pixel for a full screen canvas
      // is quite intensive. Using x+=2, y+=2 to reduce load.
      for (let x = 0; x < width; x += 2) {
        for (let y = 0; y < height; y += 2) {
          ...
          // Purple-gray silk color matching SILENT theme
          ...
          if (index < data.length) {
            ...
            // Fill the 2x2 block to avoid gaps since we skip pixels
